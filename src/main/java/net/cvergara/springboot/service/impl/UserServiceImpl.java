package net.cvergara.springboot.service.impl;

import lombok.AllArgsConstructor;
import net.cvergara.springboot.dto.UserDto;
import net.cvergara.springboot.entity.User;
import net.cvergara.springboot.exception.EmailAlreadyExistsException;
import net.cvergara.springboot.exception.ResourceNotFoundException;
import net.cvergara.springboot.mapper.AutoUserMapper;
